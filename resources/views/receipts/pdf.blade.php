...
<body>
    ...
    <table class="total-table">
        ...
        <tr>
            ...
            <td class="right"><strong>₹{{ number_format($invoice->amount_paid, 2) }}</strong></td>
        </tr>
        <tr>
            <td class="right"><strong>Amount Due:</strong></td>
            <td class="right"><strong>₹{{ number_format($invoice->amount_due, 2) }}</strong></td>
        </tr>
    </table>
